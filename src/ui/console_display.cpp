...
ConsoleDisplay::ConsoleDisplay(std::ostream& os)
    : height_ { kDefaultConsoleHeight }
    , width_{ kDefaultConsoleWidth }
    , os_{os}
{
    clear_data();
}
...
size_t ConsoleDisplay::width() const { return width_; }
size_t ConsoleDisplay::height() const { return height_; }
